    ...
    while True:
        try:
            ...
            for update in updates:
                ...
                # Security: ignore messages from anyone other than you
...
def start(tracked: dict) -> None:
    """
    Start the command listener in a daemon background thread.
    Pass bot.tracked so the listener always sees live position data.
    """
    ...
    t.start()
    log.info("Telegram listener started  (/data  /help)")
